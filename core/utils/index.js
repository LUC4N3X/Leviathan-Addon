...
const { TRACKERS, buildTrackerMagnet } = require("./torrent");
const {
    Cache,
    myCache,
    rawCache,
...
const {
    ...
    REGEX_AUDIO_CONFIRM,
    languageMapping,
    normalizeLanguageName, stripFalseItalianDomainTokens,
    parseTitleDetails,
    stripVisualPrefixes,
    normalizeSearchText,
...
module.exports = {
  ...
  REGEX_YEAR, REGEX_QUALITY_FILTER, REGEX_STRONG_ITA, REGEX_CONTEXT_IT, REGEX_ISOLATED_IT, REGEX_DOMAIN_IT, REGEX_MULTI_ITA, REGEX_TRUSTED_GROUPS, REGEX_FALSE_IT, REGEX_SUB_ONLY, REGEX_AUDIO_CONFIRM,
  languageMapping, normalizeLanguageName, stripFalseItalianDomainTokens, parseTitleDetails, stripVisualPrefixes, normalizeSearchText, isItalianByTitleMatch, isTrustedSource, getLanguageInfo, formatLanguageLabel, isSeasonPack, isGoodShortQueryMatch, chooseBestPackTitle, shouldUpdatePackTitle, base32ToHex, extractInfoHash, estimateVisualSize, estimateSeeders,
