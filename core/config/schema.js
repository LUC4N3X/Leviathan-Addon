...
const { decodeConfigSegment } = require('../security/config_crypto');
...
function decodeConfigBase64(configStr) {
  return decodeConfigSegment(configStr);
}
...
function validateConfig(input = {}) {
  ...
  const numericFilterKeys = ['maxPerQuality', 'maxSizeGB', 'minSizeGB', 'maxSizeBytes', 'minSizeBytes', 'instantDebridTop', 'warmupTop', 'savedCloudMax', 'minSeeders', 'maxSeeders', 'backgroundScraperMinResults'];
