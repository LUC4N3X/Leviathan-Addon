...
const indexerHttpAgent = new http.Agent({ keepAlive: true, maxSockets: 100 });
const indexerHttpsAgent = new https.Agent({ keepAlive: true, maxSockets: 100 });
...
async function queryRemoteIndexer(tmdbId, type, season = null, episode = null, config, meta = {}) {
    ...
    try {
        ...
        const { data } = await axios.get(url, { 
            timeout: CONFIG.TIMEOUTS.REMOTE_INDEXER,
            httpAgent: indexerHttpAgent,
            httpsAgent: indexerHttpsAgent
        });
