...
async function generateStream(type, id, config, userConfStr, reqHost, runtimeContext = {}) {
  ...
  if (isWebEnabled) streamCacheVersionParts.push('webProviderMfpRoute=mfpExtractorHeadersV3');
  ...
  return withSharedPromise(streamInflight, inflightKey, async () => {
      ...
      const cachePolicy = {
          ...
          localTtl: sourceModeFlags.liveOnlyMode ? 0 : emptyEurostreamingOnlyLocalTtl,
