...
async function generateStream(type, id, config, userConfStr, reqHost, runtimeContext = {}) {
  ...
  if (isWebEnabled) streamCacheVersionParts.push('webProviderMfpRoute=mfpExtractorHeadersV5|cb01DebugHooks=v2|cb01DomainCache=v1|lazyNoProxy=v1|altadefinizioneNoLazy=v1|altadefinizioneMfpFallback=v1|altadefinizioneVidxgoImpitMixdrop=v1|cinemacityQuickKrakenCity=v1');
