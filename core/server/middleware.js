...
function isPlaybackProxyPath(pathname) {
    ...
    return value === '/vixsynthetic.m3u8' || value.startsWith('/vixsegment') || value.startsWith('/vixaudio') || value.startsWith('/vixkey') || value.startsWith('/vixsubtitle') || value.startsWith('/vixmedia');
}
