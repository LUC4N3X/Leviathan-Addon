...
#mod-vidsrc { --border-color: #ff5a5f; --border-color-dim: rgba(255, 90, 95, 0.3); --glow-color: rgba(255, 90, 95, 0.7); --glow-color-dim: rgba(255, 90, 95, 0.15); }
...
#mod-vidsrc .m-core-icon { color: #ff5a5f; }
        ...
        if (n) {
            ...
            if (
                ...
                (mSetChecked("m-enableVix", e.filters.enableVix || !1),
                    ...
                    mSetChecked("m-enableVidsrc", e.filters.enableVidsrc || !1),
                    toggleModuleStyle("m-enableVidsrc", "mod-vidsrc"),
            ...
            (updateStatus("m-enableVix", "st-vix"),
                ...
                updateStatus("m-enableVidsrc", "st-vidsrc"),
...
function getMobileConfig() {
    ...
    return {
        ...
        filters: {
            ...
            enableVidsrc: mChecked("m-enableVidsrc"),
